...
room["main"] = {
	...
	obj : [ 
		...
		xact('next', function() { walk("garden"); }),
		vobj('Дальше','{Дальше}.'),
		vway('Дальше','Нажмите {здесь}.', "garden") ]
...
obj["woodstick"] = {
	nam : "Палка",
	dsc : "Под ногами валяется {woodstick|палка} метрового размера.",
	tak : function() { return ["Вы подобрали палку."]; },
	inv : "Палка как палка..."
};
